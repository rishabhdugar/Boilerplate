...
public class BPExecutorService extends Service {

    private static final String LOG_TAG = BPExecutorService.class.getSimpleName();
    ...
    public static void start(Context context,
                             ...
                             String postEntity,
                             int requestType) {
        Intent intent = new Intent(context, BPExecutorService.class);
